...
foreach ($archive in $archives) {
    ...
    try {
        ...
        $checks = @(@{ name = 'net-snmp'; commit = 'c29ca8d86c9259ff25b19338fbb8ceb5eedcd5e9'; ids = @('CVE-2020-15861', 'CVE-2022-24805', 'CVE-2022-24806', 'CVE-2022-24807', 'CVE-2022-24808', 'CVE-2022-24809', 'CVE-2022-24810') })
